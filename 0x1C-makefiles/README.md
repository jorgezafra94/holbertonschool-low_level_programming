** First Steps in Make ** we are going to learn about makefiles in order to know how to execute this files
...
name of the executable: holberton rules: all The all rule builds your executable variables: none

1- Requirements:

name of the executable: holberton rules: all The all rule builds your executable variables: CC, SRC CC: the compiler to be used SRC: the .c files
