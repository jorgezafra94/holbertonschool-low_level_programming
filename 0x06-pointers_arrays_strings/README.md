*this project is about pointers and arrays again, but in a deeply way*
today we are goig to solve these problems:
...
101- Add one line to a given code, so that the program prints a[2] = 98, followed by a new line.
...
102- Write a function that adds two numbers.
...
103-Write a function that prints a buffer.
